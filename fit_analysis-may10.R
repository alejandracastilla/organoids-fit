...
# fit for ala28
opts28 <- abfit_opts(pre_fit_bl_ed_pppm = 6.8, 
                     max_bl_ed_pppm = 14, 
                     auto_bl_flex_n = 5, 
                     algo_pre = "NLOPT_LN_SBPLX", 
                     auto_bl_flex=FALSE, 
                     init_damping=0)
# fit for ala29

# fit for ala29 esta mejor los [icos mas altos]
# el prefit sale error con 6, con 6.8 o  7 fuciona pero no super bien con 11 es todo flat
# el 4 lo vuelve flat
#max de 7 a 15 no hace ninguna diferencia
opts29 <- abfit_opts(pre_fit_bl_ed_pppm = 12, 
                     max_bl_ed_pppm = 7, 
                     auto_bl_flex_n = 7, 
                     algo_pre = "NLOPT_LN_SBPLX", 
                     auto_bl_flex=FALSE, 
...
opts29 <- abfit_opts(pre_fit_bl_ed_pppm = 7, 
                     max_bl_ed_pppm = 15, 
                     auto_bl_flex_n = 7, 
                     algo_pre = "NLOPT_LN_SBPLX", 
                     auto_bl_flex=FALSE, 
...
# plot(ref_res28, xlim = c(1.4,1.5) )
# plot(ref_res28, xlim = c(3.7,3.8) )

plot(ref_res29, main= 'ref_res29')
plot(ref_res29, xlim = c(1.4,1.5) )
...
# in mMols!!!
write.csv(df,"../csv/output-May10_wAla28.csv", row.names = TRUE)
